...
class ami
{
    ...
    */
    ...
    private $default_conf = array('server' => 'localhost', 'port' => "5038", 'username' => 'phpagi', 'secret' => 'phpagi');
    ...
    */
    public function __construct($parent_class = null, $config = null, $optconfig = array ())
    {
        ...
        foreach ($this->default_conf as $key => $value) {
            if (isset($this->config['asmanager'][$key]) === false) {
                $this->config['asmanager'][$key] = $value;
            }
        }
    }//end __construct()
    ...
    */
    public function sendRequest($action, $parameters = array())  {    
        if (!is_resource($this->socket)) {
            return array('error' => 'Soket error' );
    	}
    ...
    */
    ...
    // use config if not specified
        ...
        // login
        $res = $this->sendRequest('login', array('Username' => $username, 'Secret' => $secret));
    ...
    */
    ...
    {
        $result = $this->sendRequest('AbsoluteTimeout', array('Channel' => $channel, 'Timeout' => $timeout));
        return $result;
    }//end absoluteTimeout()
    ...
    */
    ...
    {
        $result = $this->sendRequest('ChangeMontior', array('Channel' => $channel, 'File' => $file));
        return $result;
    }//end changeMonitor()
    ...
    */
    public function events($eventmask)
    {
        ...
        $result = $this->sendRequest('Events', array('EventMask' => $eventmask));
        return $result;
    }//end events()
    ...
    */
    ...
    {
        $result = $this->sendRequest('Hangup', array('Channel' => $channel));
        return $result;
    }//end hangup()
    ...
    */
    ...
    {
        if ($actionId !== null) {
            $result = $this->sendRequest('ListCommands', array('ActionID' => $actionId));
        } else {
    ...
    */
    ...
    {
        if ($actionId !== null) {
            $result = $this->sendRequest('ParkedCalls', array('ActionID' => $actionId));
        } else {
    ...
    */
    ...
    {
        $result = $this->sendRequest('QueueRemove', array('Queue' => $queue, 'Interface' => $interface));
        return $result;
    }//end queueRemove()
    ...
    */
    ...
    {
        if ($actionId !== null) {
            $result = $this->sendRequest('QueueStatus', array('ActionID' => $actionId));
        } else {
    ...
    */
    ...
    {
        $result = $this->sendRequest('SetVar', array('Channel' => $channel, 'Variable' => $variable, 'Value' => $value));
        return $result;
    }//end setVar()
    ...
    */
    ...
    {
        $result = $this->sendRequest('StopMonitor', array('Channel' => $channel));
        return $result;
    }//end stopMonitor()
    ...
    */
    ...
    {
        $result = $this->sendRequest('ZapDialOffhook', array('ZapChannel' => $zapchannel, 'Number' => $number));
        return $result;
    }//end zapDialOffhook()
    ...
    */
    ...
    {
        $result = $this->sendRequest('ZapDNDoff', array('ZapChannel' => $zapchannel));
        return $result;
    }//end zapDndOff()
    ...
    */
    ...
    {
        $result = $this->sendRequest('ZapDNDon', array('ZapChannel' => $zapchannel));
        return $result;
    }//end zapDndOn()
    ...
    */
    ...
    {
        $result = $this->sendRequest('ZapHangup', array('ZapChannel' => $zapchannel));
        return $result;
    }//end zapHangup()
    ...
    */
    ...
    {
        $result = $this->sendRequest('ZapTransfer', array('ZapChannel' => $zapchannel));
        return $result;
    }//end zapTransfer()
    ...
    */
    ...
    {
        if ($actionId !== null) {
            $result = $this->sendRequest('ZapShowChannels', array('ActionID' => $actionId));
        } else {
